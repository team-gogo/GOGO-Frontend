  ...
  return (
    ...
    >
      <div className={cn('w-full', 'h-full', 'text-gray-400')}>
        <p className={cn('text-body2s', 'py-[0.75rem]')}>
          “The house always wins.”– 불변의 진리 도박은 언젠가 반드시 패배하게
          됩니다. 수많은 선택과 예측 속에서 잠깐의 승리는 달콤했을지 몰라도,
      ...
      <Button className={cn('w-full')}>확인</Button>
    </ModalLayout>
  );
};
